...
export function Nav() {
  return (
    <nav className="absolute top-0 left-0 right-0 z-50">
      <div className="max-w-[1550px] mx-auto px-12 py-8 pt-[60px]">
        <div className='flex justify-between items-center'>


        <Link href="/" className="hover:opacity-80 mr-12">
            <svg width="55" height="55" viewBox="0 0 110 110" fill="none" xmlns="http://www.w3.org/2000/svg">
